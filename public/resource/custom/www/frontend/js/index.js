        ...
        $.post(
            ...
            function(data){
                ...
                else
                {
                    ...
                    $that.find('i').addClass('fa-star text-red').removeClass('fa-star-o');
                    // $that.html('<i class="fa fa-star text-red"></i> 移出收藏');
