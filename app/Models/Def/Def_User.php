...
//    protected $connection = 'mysql_def';
    ...
    function pivot_user()
    {
        return $this->belongsToMany('App\Models\Def\Def_User','def_pivot_user_user','user_1_id','user_2_id')
            ->withPivot(['active','relation_active','type','relation_type'])->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany('App\Models\Def\Def_User','def_pivot_user_relation','mine_user_id','relation_user_id')
            ->withPivot(['active','relation_active','type','relation_type'])->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany('App\Models\Def\Def_User','def_pivot_user_relation','relation_user_id','mine_user_id')
            ->withPivot(['active','relation_active','type','relation_type'])->withTimestamps();
    }
