...
//    }
    ...
    {
        return $this->belongsToMany('App\Models\Atom\Atom_Item','pivot_item_relation','mine_item_id','relation_item_id')
...
//            ->withTimestamps();
    ...
    {
        return $this->belongsToMany('App\Models\Atom\Atom_Item','pivot_item_relation','relation_item_id','mine_item_id')
            ->wherePivot('relation_type', 1);
//            ->withTimestamps();
    }
    ...
    function items()
    {
        return $this->hasMany('App\Models\Atom\Atom_Item','item_id','id');
    }

    // 父节点
    function belong_item()
    {
        return $this->belongsTo('App\Models\Atom\Atom_Item','item_id','id');
    }
    ...
    function parent()
    {
        return $this->belongsTo('App\Models\Atom\Atom_Item','p_id','id');
    }

    // 子节点
    function children()
    {
        return $this->hasMany('App\Models\Atom\Atom_Item','p_id','id');
    }
    ...
    {
        return $this->hasMany('App\Models\Atom\Atom_Communication','item_id','id');
    }
    ...
    {
        return $this->hasMany('App\Models\Atom\Atom_Pivot_User_Collection','item_id','id');
    }
    ...
    {
        return $this->hasMany('App\Models\Atom\Atom_Pivot_User_Item','item_id','id');
    }
