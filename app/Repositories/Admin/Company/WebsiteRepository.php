...
class WebsiteRepository {
    ...
    public function get_list_datatable($post_data)
    {
        ...
        $query = Website::select("*")->where('company_id',$company_id);
        $total = $query->count();
    ...
    public function view_edit()
    {
        ...
        if($decode_id == 0) return view('admin.company.website.edit')->with(['operate'=>'create', 'encode_id'=>$id]);
        else
        {
            ...
            if($slide)
            {
                ...
                return view('admin.company.website.edit')->with(['operate'=>'edit', 'encode_id'=>$id, 'data'=>$slide]);
            }
