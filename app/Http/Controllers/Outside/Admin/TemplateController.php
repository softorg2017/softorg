...
use App\Repositories\Outside\Admin\OutsideTemplateRepository;
...
class TemplateController extends Controller
{
    ...
    {
        $this->repo = new OutsideTemplateRepository;
    }
    ...
    {
        return view('outside.admin.template.index');
    }

    public function viewList()
    {
        if(request()->isMethod('get')) return view('outside.admin.template.list');
