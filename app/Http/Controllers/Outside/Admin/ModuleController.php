...
use App\Repositories\Outside\Admin\OutsideModuleRepository;
...
class ModuleController extends Controller
{
    ...
    {
        $this->repo = new OutsideModuleRepository;
    }
    ...
    {
        return view('outside.admin.module.index');
    }

    public function viewList()
    {
        if(request()->isMethod('get')) return view('outside.admin.module.list');
