...
use App\Repositories\Outside\Admin\OutsideMenuRepository;
...
class MenuController extends Controller
{
    ...
    {
        $this->repo = new OutsideMenuRepository;
    }
    ...
    {
        return view('outside.admin.menu.index');
    }

    public function viewList()
    {
        if(request()->isMethod('get')) return view('outside.admin.menu.list');
