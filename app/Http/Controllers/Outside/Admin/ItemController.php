...
use App\Repositories\Outside\Admin\OutsideItemRepository;
...
class ItemController extends Controller
{
    ...
    {
        $this->repo = new OutsideItemRepository;
    }
    ...
    {
        return view('outside.admin.item.index');
    }

    public function viewList()
    {
        if(request()->isMethod('get')) return view('outside.admin.item.list');
