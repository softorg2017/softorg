...
use App\Services\Admin\Company\MenuService;
use App\Repositories\Admin\Company\MenuRepository;
...
class MenuController extends Controller
{
    ...
    {
        return view('admin.company.menu.index');
    }

    public function viewList()
    {
        if(request()->isMethod('get')) return view('admin.company.menu.list');
    ...
    {
        if(request()->isMethod('get')) return view('admin.company.menu.edit');
