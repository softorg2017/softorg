...
use App\Services\Admin\Company\ProductService;
use App\Repositories\Admin\Company\ProductRepository;
...
class ProductController extends Controller
{
    ...
    {
        if(request()->isMethod('get')) return view('admin.company.product.list');
