...
use App\Repositories\Org\Admin\OrgMenuRepository;
...
class MenuController extends Controller
{
    ...
    {
        $this->repo = new OrgMenuRepository;
    }
    ...
    {
        return view('org.admin.menu.index');
    }

    public function viewList()
    {
        if(request()->isMethod('get')) return view('org.admin.menu.list');
    ...
    {
        if(request()->isMethod('get')) return view('org.admin.menu.edit');
