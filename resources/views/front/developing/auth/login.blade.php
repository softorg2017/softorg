...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="/user/login" method="post" id="form-user-login">
            {{ csrf_field() }}
            ...
            <div class="row">
                ...
                <!-- /.col -->
                <div class="col-xs-4">
                    <button type="button" class="btn btn-primary btn-block btn-flat" id="user-login-submit">登陆</button>
                </div>
                <!-- /.col -->
            </div>
        </form>
        ...
        <a href="#">忘记密码</a><br>
        <a href="/user/register" class="text-center">注册新用户</a>
...
<script>
    $(function() {
        ...
        $("#user-login-submit").on('click', function() {
            ...
            $("#form-user-login").ajaxSubmit(options);
        });
    });
</script>
@endsection
