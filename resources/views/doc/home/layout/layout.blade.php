...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_DOC_HOME').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_DOC_HOME').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_DOC_HOME').'layout.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_DOC_HOME').'layout.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_DOC_HOME').'layout.control-sidebar')
