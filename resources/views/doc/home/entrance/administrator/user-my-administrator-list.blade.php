            ...
            <div class="box-header with-border" style="margin:16px 0;">
                ...
                <div class="caption pull-right">
                    ...
                    <a href="{{ url('/org/user/relation-sponsor-list') }}">
                        <button type="button" onclick="" class="btn btn-success pull-right"><i class="fa fa-plus"></i> 关联管理员</button>
                    </a>
                </div>
...
//                                '<a class="btn btn-xs item-statistics-submit" data-id="'+value+'">流量统计</a>'+
                                ...
                                $relation_type+
                                '<a class="btn btn-xs bg-navy item-administrator-delete-submit" data-id="'+data+'" >删除</a>'+
                                '';
                            return html;
                        }
                    }
...
@include(env('TEMPLATE_DOC_HOME').'entrance.administrator.user-script')
@endsection
