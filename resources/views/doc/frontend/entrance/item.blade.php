...
@section('content')
    ...
    <div class="container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 main-body-left-section section-wrapper page-item">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 main-body-right-section section-wrapper">
            <div class="main-body-right-container">
                ...
                @include(env('TEMPLATE_DOC_FRONT').'component.right-side.side-menu', ['data'=>$user])

            </div>
        </div>


        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 main-body-right-section section-wrapper pull-right" style="clear:right;">
