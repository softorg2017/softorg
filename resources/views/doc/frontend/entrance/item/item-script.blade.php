...
//            window.location.href = "/admin/statistic/statistic-item?id="+that.attr('data-id');
        ...
        // 【编辑】
        $(".item-option").on('click', ".item-edit-this", function() {
            var $this = $(this);
        ...
        // 【删除】
        $(".main-content-container").off("click",".item-delete-this").on('click', ".item-delete-this", function() {
            var $this = $(this);
            var $item_option = $this.parents('.item-option');
        ...
        // 【恢复】
        $(".main-content-container").off("click",".item-restore-this").on('click', ".item-restore-this", function() {
            var $this = $(this);
            var $item_option = $this.parents('.item-option');
        ...
        // 【永久删除】
        $(".main-content-container").off("click",".item-delete-permanently-this").on('click', ".item-delete-permanently-this", function() {
            var $this = $(this);
            var $item_option = $this.parents('.item-option');
        ...
        // 【发布】
        $(".main-content-container").off("click",".item-publish-this").on('click', ".item-publish-this", function() {
            var $this = $(this);
            var $item_option = $this.parents('.item-option');
        ...
        // 【完成】
        $(".main-content-container").off("click",".item-complete-this").on('click', ".item-complete-this", function() {
            var $this = $(this);
            var $item_option = $this.parents('.item-option');
