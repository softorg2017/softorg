...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_DOC_FRONT').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_DOC_FRONT').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_DOC_FRONT').'layout.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_DOC_FRONT').'layout.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_DOC_FRONT').'layout.control-sidebar')
