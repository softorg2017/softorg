...
{{--                @endif--}}
    ...
    <div class="form-group activity-show time-show" style="display:none;">
        ...
        <div class="col-md-8 ">
            <div class="col-md-6" style="padding-left:0;">
                <input type="text" readonly- class="form-control" name="start" placeholder="选择开始时间" value="">
            </div>
            <div class="col-md-6" style="padding-right:0;">
                <input type="text" readonly- class="form-control" name="end" placeholder="选择结束时间" value="">
            </div>
        </div>
    </div>
    ...
    <div class="form-group debate-show" style="display:none;">
        ...
        <div class="col-md-8 ">
            <div><input type="text" class="form-control" name="custom[positive]" placeholder="正方观点" value=""></div>
        </div>
    </div>
    <div class="form-group debate-show" style="display:none;">
        <label class="control-label col-md-2"><sup class="text-red">*</sup> 反方观点</label>
        <div class="col-md-8 ">
            <div><input type="text" class="form-control" name="custom[negative]" placeholder="反方观点" value=""></div>
        </div>
    </div>
