    ...
    <div class="form-group activity-show time-show" style="display:none;">
        ...
        <div class="col-md-8 ">
            <div class="col-md-6" style="padding-left:0;">
                <input type="text" class="form-control" name="start" placeholder="选择开始时间" value="@if(!empty($data->start_time)){{ date("Y-m-d H:i",$data->start_time) }}@endif" readonly>
            </div>
            <div class="col-md-6" style="padding-right:0;">
                <input type="text" class="form-control" name="end" placeholder="选择结束时间" value="@if(!empty($data->end_time)){{ date("Y-m-d H:i",$data->end_time) }}@endif" readonly>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-md-8 ">
            <div>
                ...
                <!-- 加载编辑器的容器 -->
                <script id="item-edit-container" name="content" type="text/plain">{!! $data->content or '' !!}</script>
                <!-- 实例化编辑器 -->
            ...
            <div class="fileinput fileinput-new" data-provides="fileinput">
                <div class="fileinput-new thumbnail">
                    @if(!empty($data->cover_pic))
                        <img src="{{ url(env('LW_DOMAIN_CDN').'/'.$data->cover_pic) }}" alt="" />
                    @endif
                </div>
