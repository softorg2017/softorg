    ...
    <div class="col-md-8 col-md-offset-2 margin-top-64px margin-bottom-64px bg-white">
        <div class="box- box-info- form-container">
            ...
            <div class="box-footer">
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <button type="button" class="btn btn-primary" id="e-submit-for-item-edit"><i class="fa fa-check"></i> 提交</button>
...
@section('custom-style')
    <style>
        .tableArea table { min-width:1080px; }
...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                ...
                "searching": false,
                "ajax": {
                    'url': "{{ url('/home/item/item-list?item-type='.request('item-type')) }}",
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            else if(data == 11)
                            {
                                if(row.item_id == 0)
                                {
                                    return '<small class="btn-xs bg-orange">书目</small><small class="btn-xs bg-orange">封面</small>';
                                }
                                else
                                {
...
//                            if(row.is_me == 1 && row.active == 0)
                            ...
                            var $edit_html = '';
                            $edit_html = '<a class="btn btn-xs btn-primary item-edit-show" data-id="'+data+'">编辑</a>';
