...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" href="{{ env('LW_FAVICON_DOC') }}">
    <link rel="shortcut icon" type="image/png" href="{{ env('LW_FAVICON_DOC') }}">
    <link rel="icon" sizes="16x16 32x32 64x64" href="{{ env('LW_FAVICON_DOC') }}">
    <link rel="icon" type="image/png" sizes="196x196" href="{{ env('LW_FAVICON_DOC') }}">
...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('LW_TEMPLATE_DOC_FRONT').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('LW_TEMPLATE_DOC_FRONT').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('LW_TEMPLATE_DOC_FRONT').'layout.main-content')

    {{--main-footer--}}
    @include(env('LW_TEMPLATE_DOC_FRONT').'layout.main-footer')

    {{--control-sidebar--}}
    @include(env('LW_TEMPLATE_DOC_FRONT').'layout.control-sidebar')
