...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" href="{{ env('LW_FAVICON_SUPER') }}">
    <link rel="shortcut icon" type="image/png" href="{{ env('LW_FAVICON_SUPER') }}">
    <link rel="icon" sizes="16x16 32x32 64x64" href="{{ env('LW_FAVICON_SUPER') }}">
    <link rel="icon" type="image/png" sizes="196x196" href="{{ env('LW_FAVICON_SUPER') }}">
...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('LW_TEMPLATE_SUPER_ADMIN').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('LW_TEMPLATE_SUPER_ADMIN').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('LW_TEMPLATE_SUPER_ADMIN').'layout.main-content')

    {{--main-footer--}}
    @include(env('LW_TEMPLATE_SUPER_ADMIN').'layout.main-footer')

    {{--control-sidebar--}}
    @include(env('LW_TEMPLATE_SUPER_ADMIN').'layout.control-sidebar')
