            ...
            <div class="box-body datatable-body item-main-body" id="item-main-body">
                ...
                <div class="row col-md-12 datatable-search-row">
                    <div class="input-group">
                        ...
                        <select class="form-control form-filter" name="item-category" style="width:88px;">
                            <option value ="-1">全部</option>
                            <option value ="1">DOC</option>
                            <option value ="100">ATOM</option>
                        </select>
...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                ...
                "ajax": {
                    ...
                    "data": function (d) {
                        ...
                        d.category = $('select[name="item-category"]').val();
                    },
                },
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            {
                                return '<small class="btn-xs bg-primary">Doc</small>';
                            }
                            else if(row.item_category == 100)
                            {
                                return '<small class="btn-xs bg-black">Atom</small>';
                            }
                            else
                            {
                                return '--';
...
@include(env('LW_TEMPLATE_SUPER_ADMIN').'entrance.item.item-list-script')
@endsection
