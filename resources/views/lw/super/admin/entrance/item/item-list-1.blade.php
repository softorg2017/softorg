@extends(env('TEMPLATE_LW_SUPER_ADMIN').'layout.layout')


@section('head_title','【Super】内容列表')
...
//                                    '<a class="btn btn-xs item-statistics-submit" data-id="'+value+'">统计</a>'+
...
@include(env('TEMPLATE_LW_SUPER_ADMIN').'entrance.item.item-script')
@endsection
