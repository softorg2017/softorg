...
@section('head_title')
    {{ $title_text or '用户列表' }} - 超级管理员系统 - 如未科技
@endsection


@section('header','')
@section('description','用户列表 - 超级管理员后台 - 如未科技')
@section('breadcrumb')
            ...
            <div class="box-body datatable-body item-main-body" id="item-main-body">
                ...
                <div class="row col-md-12 datatable-search-row">
                    <div class="input-group">
                        ...
                        <select class="form-control form-filter" name="user-category" style="width:88px;">
                            <option value ="-1">全部</option>
                            <option value ="1">个人用户</option>
                            <option value ="9">轻博</option>
                            <option value ="19">轻企</option>
                            <option value ="29">组织</option>
                        </select>
...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                ...
                "ajax": {
                    ...
                    "data": function (d) {
                        ...
                        d.category = $('select[name="user-category"]').val();
//
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            if(row.creator)
                            {
                                return '<a target="_blank" href="/user/'+data+'">'+row.creator.username+'</a>';
                            }
                            else return row.creator_id;
                        }
                    },
                    {
                        "className": "text-left",
...
@include(env('LW_TEMPLATE_SUPER_ADMIN').'entrance.user.user-list-script')
@endsection
