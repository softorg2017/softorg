@extends(env('TEMPLATE_DOC_ATOM').'layout.auth')

@section('title','管理员登陆 - 如未科技')
...
<div class="login-box">
    ...
    <div class="login-box-body">
        <p class="login-box-msg">管理员后台登陆</p>
        ...
        <form action="/admin/login" method="post" id="form-admin-login">
            ...
            {{--</div>--}}
            <div class="form-group has-feedback">
                <input type="mobile" class="form-control" name="mobile" placeholder="手机">
