...
@section('breadcrumb')
    ...
    <li><a href="#"><i class="fa "></i>当前</a></li>
@endsection
        ...
        <div class="box box-info form-container">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 ">
                        <textarea class="form-control" name="description" rows="6" placeholder="描述">{!! $data->description or '' !!}</textarea>
                    </div>
                </div>
...
@include(env('LW_TEMPLATE_ATOM_ADMIN').'entrance.item.item-edit-script')
@endsection
