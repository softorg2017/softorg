...
<head>
    ...
    <link rel="shortcut icon" type="image/ico" href="{{ url('favicon/favicon-A-A.ico') }}">
    <link rel="shortcut icon" type="image/png" href="{{ url('favicon/alphabet-A.jpeg') }}">
    <link rel="icon" sizes="16x16 32x32 64x64" href="{{ url('favicon/favicon-A-A.ico') }}">
    <link rel="icon" type="image/png" sizes="196x196" href="{{ url('favicon/alphabet-A.jpeg') }}">
...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_ATOM_FRONT').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_ATOM_FRONT').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_ATOM_FRONT').'layout.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_ATOM_FRONT').'layout.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_ATOM_FRONT').'layout.control-sidebar')
...
<script src="{{ asset('/resource/custom/atom/frontend/js/index.js') }}"></script>
<script>
    $(function() {
//        $('article').readmore({
//            speed: 150,
