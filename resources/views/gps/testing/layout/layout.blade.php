...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_GPS_TEST').'layout.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_GPS_TEST').'layout.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_GPS_TEST').'layout.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_GPS_TEST').'layout.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_GPS_TEST').'layout.control-sidebar')
