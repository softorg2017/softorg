...
<header class="main-header">
        ...
        <a href="{{ url('/admin') }}" class="logo">
            ...
            <span class="logo-lg"><b>GPS</b></span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            @if(!empty(Auth::guard('gps')->user()->portrait_img))
                                <img src="{{ url(env('DOMAIN_CDN').'/'.Auth::guard('gps')->user()->portrait_img) }}" class="user-image" alt="User Image">
                            @else
                                <img src="/AdminLTE/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
                            @endif
                            <!-- hidden-xs hides the username on small devices so only the image appears. -->
                            <span class="hidden-xs">{{ Auth::guard('gps')->user()->username }}</span>
                        </a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    {{ Auth::guard('gps')->user()->username }} - 管理员
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{ url('/gps/info/index') }}" class="btn btn-default btn-flat">个人资料</a>
                                </div>
                                <div class="pull-right">
                                    <a href="{{ url('/gps/logout') }}" class="btn btn-default btn-flat">退出</a>
                                </div>
                            </li>
                        </ul>
                    </li>
