...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include(env('TEMPLATE_GPS_ADMIN').'component.main-header')

    {{--main-sidebar--}}
    @include(env('TEMPLATE_GPS_ADMIN').'component.main-sidebar')

    {{--main-content--}}
    @include(env('TEMPLATE_GPS_ADMIN').'component.main-content')

    {{--main-footer--}}
    @include(env('TEMPLATE_GPS_ADMIN').'component.main-footer')

    {{--control-sidebar--}}
    @include(env('TEMPLATE_GPS_ADMIN').'component.control-sidebar')
