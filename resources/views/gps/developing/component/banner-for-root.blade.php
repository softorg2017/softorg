...
<div class="banner-container main-slider-wrapper clearfix">
    <div class="banner-slider-container">
        <div class="banner-slider-box" id="main-slider">
                {{--<div class="slide"><img src="{{ url('/resource/common/images/bg/bg.jpg') }}" alt="Slide"></div>--}}
                <div class="slide"><img src="{{ url('/resource/common/images/bg/bg-grey-1.jpeg') }}" alt="Slide"></div>
                <div class="slide"><img src="{{ url('/resource/common/images/bg/bg-grey-2.jpeg') }}" alt="Slide"></div>
