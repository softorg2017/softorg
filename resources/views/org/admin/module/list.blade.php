...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-info">
            ...
            <div class="box-body datatable-body" id="module-main-body">
                <!-- datatable start -->
    ...
    $(function() {
        ...
        $("#module-main-body").on('click', ".module-enable-submit", function() {
            ...
            layer.msg('确定启用该"目录"？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{url(config('common.org.admin.prefix').'/admin/module/enable')}}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            id:that.attr('data-id')
                        },
        ...
        $("#module-main-body").on('click', ".module-disable-submit", function() {
            ...
            layer.msg('确定禁用该"目录"？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{url(config('common.org.admin.prefix').'/admin/module/disable')}}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            id:that.attr('data-id')
                        },
