                        ...
                        <ul class="dropdown-menu">
                            <li class="header">
                                <a href="{{url(config('common.org.admin.prefix').'/module/create')}}">
                                    <i class="fa fa-plus text-red"></i> 添加模块
                                </a>
                            </li>
                            <li class="header">
                                <a href="{{url(config('common.org.admin.prefix').'/menu/create')}}">
                            ...
                            <li class="header _none">
                                <a href="{{url('/product/create')}}"><i class="fa fa-circle-o text-red"></i>添加产品</a>
                            </li>
                            <li class="header _none">
                                <a href="{{url('/article/create')}}"><i class="fa fa-circle-o text-red"></i>添加文章</a>
                            </li>
                            <li class="header _none">
                                <a href="{{url('/activity/create')}}"><i class="fa fa-circle-o text-red"></i>添加活动</a>
                            </li>
                            <li class="header _none">
                                <a href="{{url('/survey/create')}}"><i class="fa fa-circle-o text-red"></i>添加问卷</a>
                            </li>
                            <li class="header _none">
                                <a href="{{url('/slide/create')}}"><i class="fa fa-circle-o text-red"></i>添加幻灯片</a>
                            </li>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="{{url(config('common.org.admin.prefix').'/administrator/index')}}" class="btn btn-default btn-flat">个人资料</a>
                                </div>
                                <div class="pull-right">
                                    <a href="{{url(config('common.org.admin.prefix').'/logout')}}" class="btn btn-default btn-flat">退出</a>
                                </div>
                            </li>
                        </ul>
                    </li>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href="{{url(config('common.org.admin.prefix').'/info/index')}}">
                        <i class="fa fa-sun-o text-aqua"></i> <span>基本信息</span>
                    </a>
                </li>
                
                <li class="treeview" style="display:none;">
                    <a href="{{url(config('common.org.admin.prefix').'/info/edit')}}">
                ...
                <li class="treeview" style="display:none;">
                    ...
                    <ul class="treeview-menu">
                        <li style="display:none;">
                            <a href="{{url(config('common.org.admin.prefix').'/website/edit')}}">
                                <i class="fa fa-circle-o text-aqua"></i>详细编辑
                            </a>
                        </li>
                        <li>
                            <a href="{{url(config('common.org.admin.prefix').'/softorg/edit/home')}}">
                                <i class="fa fa-circle-o text-aqua"></i>编辑展示主页
                            </a>
                        </li>
                        <li>
                            <a href="{{url(config('common.org.admin.prefix').'/softorg/edit/introduction')}}">
                                <i class="fa fa-circle-o text-aqua"></i>编辑简介详情
                            </a>
                        </li>
                        <li>
                            <a href="{{url(config('common.org.admin.prefix').'/softorg/edit/contactus')}}">
                                <i class="fa fa-circle-o text-aqua"></i>编辑联系我们
                            </a>
                        </li>
                        <li>
                            <a href="{{url(config('common.org.admin.prefix').'/softorg/edit/culture')}}">
                ...
                <li class="treeview">
                    <a href="{{url(config('common.org.admin.prefix').'/module/list')}}">
                        <i class="fa fa-sun-o text-aqua"></i> <span>模块列表</span>
                    </a>
                </li>

                <li class="treeview">
                    <a href="{{url(config('common.org.admin.prefix').'/website/style')}}">
                ...
                <li class="treeview">
                    <a href="{{url(config('common.org.admin.prefix').'/menu/list')}}">
                        <i class="fa fa-folder-open-o text-yellow"></i> <span>目录列表</span>
                    </a>
                </li>

                <li class="treeview">
                    <a href="{{url(config('common.org.admin.prefix').'/item/list')}}">
                        <i class="fa fa-file-text-o text-yellow"></i> <span>内容列表</span>
                    </a>
                </li>

                <li class="treeview" style="display:none;">
                    <a href="{{url(config('common.org.admin.prefix').'/menu/sort')}}">
                ...
                <li class="treeview" style="display:none;">
                    ...
                    <ul class="treeview-menu">
                        <li>
                            <a href="{{url(config('common.org.admin.prefix').'/product/list')}}">
                                <i class="fa fa-file-text text-red"></i> <span>产品列表</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{url(config('common.org.admin.prefix').'/article/list')}}">
                                <i class="fa fa-file-text text-red"></i> <span>文章列表</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{url(config('common.org.admin.prefix').'/activity/list')}}">
                                <i class="fa fa-calendar-check-o text-red"></i> <span>活动/会议列表</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{url(config('common.org.admin.prefix').'/survey/list')}}">
                                <i class="fa fa-question-circle text-red"></i> <span>调研问卷列表</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{url(config('common.org.admin.prefix').'/slide/list')}}">
                ...
                <li class="treeview">
                    ...
                    <a href="{{url(config('common.org.admin.prefix').'/statistics/website')}}"><i class="fa fa-bar-chart text-green"></i> <span>流量统计</span></a>
                </li>
                ...
                <li class="treeview" style="display:none;">
                    <a href="{{url(config('common.org.admin.prefix').'/administrator/password/reset')}}">
