...
@section('breadcrumb')
    ...
    <li><a href="{{url(config('common.org.admin.prefix').'/menu/list')}}"><i class="fa "></i>目录列表</a></li>
...
//                "aLengthMenu": [[20, 50, 200, 500, -1], ["20", "50", "200", "500", "全部"]],
                ...
                "searching": false,
                "ajax": {
                    'url': "{{url(config('common.org.admin.prefix').'/menu/list')}}",
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
    ...
    $(function() {
        ...
        $("#menu-main-body").on('click', ".item-delete-submit", function() {
            ...
            layer.msg('确定要删除该"目录"么', {
                ...
                ,yes: function(index){
                    $.post(
                            "{{url(config('common.org.admin.prefix').'/menu/delete')}}",
                            {
        ...
        $("#menu-main-body").on('click', ".item-enable-submit", function() {
            ...
            layer.msg('确定启用该"目录"？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{url(config('common.org.admin.prefix').'/menu/enable')}}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            id:that.attr('data-id')
                        },
        ...
        $("#menu-main-body").on('click', ".item-disable-submit", function() {
            ...
            layer.msg('确定禁用该"目录"？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{url(config('common.org.admin.prefix').'/menu/disable')}}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            id:that.attr('data-id')
                        },
