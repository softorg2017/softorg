        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 ">
                        <div class="info-img-block"><img src="{{ url(env('DOMAIN_CDN').'/'.$org->wechat_qrcode) }}" alt=""></div>
                    </div>
                </div>
                {{--微博--}}
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 ">
                        <div class="info-img-block"><img src="{{ url(env('DOMAIN_CDN').'/'.$org->logo) }}" alt=""></div>
                    </div>
                </div>
                {{--qrcode--}}
                <div class="form-group _none">
                    <label class="control-label col-md-2">首页二维码：</label>
                    <div class="col-md-8 ">
                        <div class="info-img-block"><img src="{{ url(env('DOMAIN_CDN').'/'.$org->logo) }}" alt=""></div>
                    </div>
                </div>
                ...
                <div class="form-group _none">
                    <label class="control-label col-md-2">【首页二维码】</label>
                    <div class="col-md-8 ">
                        <a class="btn btn-success _left" target="_blank" href="/download_root_qrcode">下载首页二维码</a>
                    </div>
                </div>
            </div>
            </form>
