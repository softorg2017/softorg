        ...
        <div class="box box-info">
            ...
            <div class="box-header with-border" style="margin:16px 0;">
                <div class="caption">
                    ...
                    <a href="{{url('/admin/company/product/create')}}">
    ...
    var TableDatatablesAjax = function () {
        var datatableAjax = function () {
            ...
            var ajax_datatable = dt.DataTable({
                ...
                "searching": false,
                "ajax": {
                    'url': '/admin/company/product/list',
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
                    ...
                    },
                    {
                        ...
                        render: function(value) {
                            var html =
                                    ...
                                    '</button>'+
                                    '<ul class="dropdown-menu" role="menu">'+
                                    '<li><a href="/admin/company/product/edit?id='+value+'">编辑</a></li>'+
                                    '<li><a href="/admin/company/product/delete/'+value+'">删除</a></li>'+
                                    '<li><a href="#">启用</a></li>'+
                                    '<li><a href="#">禁用</a></li>'+
                                    '<li class="divider"></li>'+
                                    '<li><a href="#">Separated link</a></li>'+
