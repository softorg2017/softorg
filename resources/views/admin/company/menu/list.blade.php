...
@section('breadcrumb')
    ...
    <li><a href="{{url('/admin/company/menu/list')}}"><i class="fa "></i>产品目录列表</a></li>
        ...
        <div class="box box-info">
            ...
            <div class="box-header with-border" style="margin:16px 0;">
                ...
                <div class="pull-right">
                    <a href="{{url('/admin/company/menu/create')}}">
                    ...
                    },
                    {
                        ...
                        render: function(value) {
                            var html =
                                    ...
                                    '</button>'+
                                    '<ul class="dropdown-menu" role="menu">'+
                                    '<li><a href="/admin/company/menu/edit?id='+value+'">编辑</a></li>'+
                                    '<li><a href="/admin/company/menu/delete/'+value+'">删除</a></li>'+
                                    '<li><a href="#">启用</a></li>'+
                                    '<li><a href="#">禁用</a></li>'+
                                    '<li class="divider"></li>'+
                                    '<li><a href="#">Separated link</a></li>'+
