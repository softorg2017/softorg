                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8 ">
                        <div>
                            ...
                            <!-- 加载编辑器的容器 -->
                            <script id="container" name="content" type="text/plain">{!! $data->introduction or '' !!}</script>
                            <!-- 实例化编辑器 -->
            ...
            <div class="box-footer">
                <div class="row" style="margin:16px 0;">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <a target="_blank" href="/org/{{ $org->website_name }}/introduction"><button class="btn btn-success _right">查看简介</button></a>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(function() {
        ...
        $("#edit-introduction-submit").on('click', function() {
            var options = {
                url: "/admin/softorg/edit/introduction",
                type: "post",
                dataType: "json",
                // target: "#div2",
            ...
            $("#form-edit-introduction").ajaxSubmit(options);
        });
    });
</script>
<script type="text/javascript">
