            ...
            <div class="foto-box">
                ...
                <div class="social-box">
                    ...
                    <div id="met-weixin-content" class="hide">
                        <div class="text-center met-weixin-img"><img src="{{url('templates/themes/metinfo/img/1422258610.jpg')}}" /></div>
                    </div>
    ...
    <div class="main-box">
        ...
        <div class="window-box">
            ...
            <div class="window-head">
                <div class="head-left">
                    <img src="{{url('templates/themes/metinfo/img/1481892407.png')}}">
                </div>
                ...
                <div class="head-right r1">
                    <a href="tel:4000-000-000" title="4000-000-000">
            ...
            <div class="window-cut">
                ...
                <div class="window-bin" data-hash="banners">
                    <div class="window-back banner" data-title="首页">
                        <div class="banner-box">
                            <div class="banner-cut">
                                ...
                                <div class="banner-bin swiper-lazy" data-background="{{url('templates/themes/metinfo/img/1481164379.jpg')}}">
					  ...
					  <span class="w23">始于 2009 - 2017 展望未来<br/>专注于设计体验，专业于解决方案</span>
					</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="banner-bin swiper-lazy" data-background="{{url('templates/themes/metinfo/img/1481161992.jpg')}}">
					...
					<span class="w2 wc">
					  ...
					  <span class="w23">不是非要高大上，只是醉心于设计<br/>我们想，再上一个好案例</span>
                                ...
                                <div class="banner-bin swiper-lazy" data-background="{{url('templates/themes/metinfo/img/1481163591.jpg')}}">
                                    <div class="table-box">
                                        <div class="table-cell">
					...
					<span class="w2 cc">
					  ...
					  <span class="w23">我说，业界没有最好的技术，只有最棒的技术开发者<br/>定制研发，为您的客户和团队</span>
                                ...
                                <div class="banner-bin swiper-lazy" data-background="{{url('templates/themes/metinfo/img/1481164132.jpg')}}">
                                    <div class="table-box">
                                        <div class="table-cell">
			  ...
			  <ol class="banner-ol">
			    ...
			    <li class="banner-li"><a href="#" title="从微信、钉钉等APP，看六种常见的loading 加载设计">从微信、钉钉等APP，看六种常见的loading 加载设计</a></li>
                                ...
                                <p><a href="news/index.html" title="新闻资讯">more</a></p>
                            </div>
                    ...
                    <div class="window-back swiper-lazy" data-title="品质" data-background="https://images.metinfo.cn/m/M1156008/328/upload/M1156008/328/201612/1481169859.jpg">
                        ...
                        <div class="table-box">
                            <div class="table-cell">
                                ...
                                <div class="worth-text"><a href="show/index.html" title="你以为看到了网站的全部？">你以为看到了网站的全部？</a></div>
                            ...
                            <div class="table-cell">
                                ...
                                <div class="about-box">
                                    <div class="about-cut">
                                        ...
                                        <div class="about-bin" title="思想">
                                            <p class="about-sxtitle">厚积薄发</p>
                                            <p>登上峰顶，不是为了饱览风光，是为了寻找更高的山峰<br/>日出东方，告别了昨天的荣耀，将光芒照向更远的地方<br/>一路上，我们更在意如何积累和沉淀</p><p class="about-sixiang">下一秒，让你看，我们到底有多强</p>
                                        </div>

                                        <div class="about-bin" title="关于">
                                            <p class="about-titless">互联网+</p>
                                            <p>“互联网+”是创新2.0下的互联网发展的新业态，是知识社会创新2.0推动下的互联网形态演进及其催生的经济社会发展新形态。“互联网+”是互联网思维的进一步实践成果，推动经济形态不断地发生演变，从而带动社会经济实体的生命力，为改革、创新、发展提供广阔的网络平台。</p>
                                        </div>

                                        <div class="about-bin" title="荣誉">
                                            <p class="about-titless">放下荣誉，放眼未来</p>
                                            <div class="about-time">
                                                <p>2009年<span style="text-decoration:underline;">-</span>荣获广东省创新企业</p>
                                                ...
                                                <p>2012年<span style="text-decoration:underline;">-</span>成功注册 &quot; 互联网+ &quot; 商标，树立品牌</p><p>2013年<span style="text-decoration:underline;">-</span>已拥有自主知识产权，国家软件著作权达12项之多</p>
                                            </div>
                                        </div>
                                ...
                                <div class="hidden visible-lg-block">
                                    <div class="contact-box">
                                        ...
                                        <div class="contact-right">
                                            <p>Email：admin@softorg.cn</p>
                                            <p>中文域名：互联网.中国/互联网.com</p>
        ...
        <script src="{{ asset('templates/themes/metinfo/js/all.js') }}"></script>
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 margin-bottom-20">
                        <a href="index.php-lang=en.html" class="btn btn-block btn-outline btn-default btn-squared text-nowrap" title="English">
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 margin-bottom-20">
                        <a href="index.php-lang=tc.html" class="btn btn-block btn-outline btn-default btn-squared text-nowrap" title="繁体中文">
                            <span class="flag-icon flag-icon-cn pull-left"></span>
                            繁体中文
                        </a>
                    </div>
