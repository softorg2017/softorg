...
<div class="wrapper">
    ...
    {{--main-header--}}
    @include('root.admin.component.main-header')

    {{--main-sidebar--}}
    @include('root.admin.component.main-sidebar')

    {{--main-content--}}
    @include('root.admin.component.main-content')

    {{--main-footer--}}
    @include('root.admin.component.main-footer')

    {{--control-sidebar--}}
    @include('root.admin.component.control-sidebar')
