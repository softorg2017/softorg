        ...
        <div class="box box-info">
            ...
            <div class="box-header with-border" style="margin:16px 0;">
                ...
                <div class="pull-right">
                    <a href="{{url(config('outside.admin.prefix').'/admin/menu/create')}}">
            ...
            <div class="box-footer">
                <div class="row" style="margin:16px 0;">
                    <div class="col-md-offset-0 col-md-9">
                        ...
                        <a href="{{url(config('outside.admin.prefix').'/admin/menu/sort')}}">
    ...
    var TableDatatablesAjax = function () {
        var datatableAjax = function () {
            ...
            var ajax_datatable = dt.DataTable({
                ...
                "searching": false,
                "ajax": {
                    'url': "{{url(config('outside.admin.prefix').'/admin/menu/list')}}",
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
...
//                        d.updated_at_to = $('input[name="updated_at_to"]').val();
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        'orderable': false,
                        render: function(data, type, row, meta) {
                            return '<a href="/{{config('outside.admin.prefix')}}/admin/menu/items?id='+data+'"><button type="button" class="btn btn-sm bg-purple">内容列表</button></a>';
                        }
                    },
                    {
                        'data': 'encode_id',
                        ...
                        render: function(value) {
                            var html =
                                    ...
                                    '</button>'+
                                    '<ul class="dropdown-menu" role="menu">'+
                                    '<li><a href="/{{config('outside.admin.prefix')}}/admin/menu/edit?id='+value+'">编辑</a></li>'+
                                    ...
                                    '<li><a href="/{{config('outside.admin.prefix')}}/admin/statistics/menu?id='+value+'">流量统计</a></li>'+
                                    '<li class="divider"></li>'+
                                    '<li><a href="#">Separated link</a></li>'+
                                    '</ul>'+
                                    '</div>';
    ...
    $(function() {
        ...
        $("#menu-main-body").on('click', ".menu-delete-submit", function() {
            ...
            layer.msg('确定要删除该"目录"么', {
                ...
                ,yes: function(index){
                    $.post(
                            "{{url(config('outside.admin.prefix').'/admin/menu/delete')}}",
                            {
        ...
        $("#menu-main-body").on('click', ".menu-enable-submit", function() {
            ...
            layer.msg('确定启用该"目录"？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{url(config('outside.admin.prefix').'/admin/menu/enable')}}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            id:that.attr('data-id')
                        },
        ...
        $("#menu-main-body").on('click', ".menu-disable-submit", function() {
            ...
            layer.msg('确定禁用该"目录"？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{url(config('outside.admin.prefix').'/admin/menu/disable')}}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            id:that.attr('data-id')
                        },
