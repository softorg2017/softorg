...
@section('breadcrumb')
    ...
    <li><a href="{{url(config('outside.admin.prefix').'/admin/item/list')}}"><i class="fa "></i>内容列表</a></li>
        ...
        <div class="box box-info">
            ...
            <div class="box-header with-border" style="margin:16px 0;">
                ...
                <div class="caption">
                    ...
                    <a href="{{url(config('outside.admin.prefix').'/admin/item/create')}}">
    ...
    var TableDatatablesAjax = function () {
        var datatableAjax = function () {
            ...
            var ajax_datatable = dt.DataTable({
                ...
                "searching": false,
                "ajax": {
                    'url': "{{url(config('outside.admin.prefix').'/admin/item/list')}}",
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
                ...
                "columns": [
                    {
                        ...
                        render: function(data, type, row, meta) {
                            return '<a target="_blank" href="/org/item/'+data+'">'+row.title+'</a>';
                        }
                    },
                    {
                        'data': 'menus',
                    ...
                    },
                    {
                        ...
                        render: function(value) {
                            var html =
                                    ...
                                    '</button>'+
                                    '<ul class="dropdown-menu" role="menu">'+
                                    '<li><a href="/{{config('outside.admin.prefix')}}/admin/item/edit?id='+value+'">编辑</a></li>'+
                                    ...
                                    '<li><a href="/{{config('outside.admin.prefix')}}/admin/statistics/item?id='+value+'">流量统计</a></li>'+
    ...
    $(function() {
        ...
        $("#item-main-body").on('click', ".item-delete-submit", function() {
            ...
            layer.msg('确定要删除该"产品"么', {
                ...
                ,yes: function(index){
                    $.post(
                            "{{url(config('outside.admin.prefix').'/admin/item/delete')}}",
                            {
        ...
        $("#item-main-body").on('click', ".item-enable-submit", function() {
            ...
            layer.msg('确定启用该"产品"？', {
                ...
                ,yes: function(index){
                    $.post(
                            "{{url(config('outside.admin.prefix').'/admin/item/enable')}}",
                            {
                                _token: $('meta[name="_token"]').attr('content'),
                                id:that.attr('data-id')
                            },
        ...
        $("#item-main-body").on('click', ".item-disable-submit", function() {
            ...
            layer.msg('确定禁用该"产品"？', {
                ...
                ,yes: function(index){
                    $.post(
                            "{{url(config('outside.admin.prefix').'/admin/item/disable')}}",
                            {
                                _token: $('meta[name="_token"]').attr('content'),
                                id:that.attr('data-id')
                            },
