...
<script>
    $(function() {
        ...
        $("#edit-item-submit").on('click', function() {
            var options = {
                url: "{{url(config('outside.admin.prefix').'/admin/item/edit')}}",
                type: "post",
                dataType: "json",
                // target: "#div2",
                success: function (data) {
                    ...
                    {
                        layer.msg(data.msg);
                        location.href = "{{url(config('outside.admin.prefix').'/admin/item/list')}}";
                    }
                }
            };
        ...
        $('#menus').select2({
            ajax: {
                url: "{{url(config('outside.admin.prefix').'/admin/item/select2_menus')}}",
                dataType: 'json',
                delay: 250,
