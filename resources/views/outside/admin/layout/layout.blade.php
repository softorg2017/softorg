...
<div class="wrapper">
    ...
    {{--<!-- Main Header -->--}}
    @include('outside.admin.layout.component.main-header')

    {{--<!-- Left side column. contains the logo and sidebar -->--}}
    @include('outside.admin.layout.component.main-sidebar')
    ...
    {{--<!-- Main Footer -->--}}
    @include('outside.admin.layout.component.main-footer')

    {{--<!-- Control Sidebar -->--}}
    @include('outside.admin.layout.component.control-sidebar')
