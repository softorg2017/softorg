...
@section('breadcrumb')
    ...
    <li><a href="{{url(config('outside.admin.prefix').'/admin/module/list')}}"><i class="fa "></i> 模块列表</a></li>
...
//        });
        ...
        $("#edit-module-submit").on('click', function() {
            var options = {
                url: "{{url(config('outside.admin.prefix').'/admin/module/edit')}}",
                type: "post",
                dataType: "json",
                // target: "#div2",
                success: function (data) {
                    ...
                    {
                        layer.msg(data.msg);
                        location.href = "{{url(config('outside.admin.prefix').'/admin/module/list')}}";
                    }
                }
            };
