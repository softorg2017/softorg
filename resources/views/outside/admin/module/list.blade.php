            ...
            <div class="box-footer">
                <div class="row" style="margin:16px 0;">
                    <div class="col-md-offset-0 col-md-9">
                        ...
                        <a href="{{url(config('common.org.admin.prefix').'/admin/module/sort')}}">
    ...
    var TableDatatablesAjax = function () {
        var datatableAjax = function () {
            ...
            var ajax_datatable = dt.DataTable({
                ...
                "searching": false,
                "ajax": {
                    'url': "{{url(config('outside.admin.prefix').'/admin/module/list')}}",
                    "type": 'POST',
                    "dataType" : 'json',
                    "data": function (d) {
                    ...
                    },
                    {
                        ...
                        render: function(value) {
                            var html =
                                    ...
                                    '</button>'+
                                    '<ul class="dropdown-menu" role="menu">'+
                                    '<li><a href="/{{config('outside.admin.prefix')}}/admin/module/edit?id='+value+'">编辑</a></li>'+
                                    ...
                                    {{--'<li><a href="/{{config('outside.admin.prefix')}}/admin/statistics/module?id='+value+'">流量统计</a></li>'+--}}
                                    '<li class="divider"></li>'+
                                    '<li><a href="#">Separated link</a></li>'+
                                    '</ul>'+
                                    '</div>';
    ...
    $(function() {
        ...
        $("#module-main-body").on('click', ".module-delete-submit", function() {
            ...
            layer.msg('确定要删除该"目录"么', {
                ...
                ,yes: function(index){
                    $.post(
                            "{{url(config('outside.admin.prefix').'/admin/module/delete')}}",
                            {
        ...
        $("#module-main-body").on('click', ".module-enable-submit", function() {
            ...
            layer.msg('确定启用该"目录"？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{url(config('outside.admin.prefix').'/admin/module/enable')}}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            id:that.attr('data-id')
                        },
        ...
        $("#module-main-body").on('click', ".module-disable-submit", function() {
            ...
            layer.msg('确定禁用该"目录"？', {
                ...
                ,yes: function(index){
                    $.post(
                        "{{url(config('outside.admin.prefix').'/admin/module/disable')}}",
                        {
                            _token: $('meta[name="_token"]').attr('content'),
                            id:that.attr('data-id')
                        },
