@extends('inside.admin.layout.auth')
...
<div class="login-box">
    <div class="login-logo">
        <a href="/outside/admin"><b>对外管理员</b> 后台登录</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">管理员登陆</p>

        <form action="/outside/admin/login" method="post" id="form-admin-login">
            {{ csrf_field() }}
