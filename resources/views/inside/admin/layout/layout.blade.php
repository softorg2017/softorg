...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{url('/admin')}}" class="logo">
            ...
            <span class="logo-lg"><b>Inside</b></span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs">{{Auth::guard('inside_admin')->user()->nickname}}</span>
                        </a>
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                ...
                                <p>
                                    {{Auth::guard('inside_admin')->user()->nickname}} - Web Developer
                            ...
                            <li class="user-footer">
                                ...
                                <div class="pull-right">
                                    <a href="{{url('/inside/admin/logout')}}" class="btn btn-default btn-flat">退出</a>
                                </div>
                            </li>
                        </ul>
                    </li>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                ...
                <div class="pull-left info">
                    <p>{{Auth::guard('inside_admin')->user()->nickname}}</p>
                    <!-- Status -->
