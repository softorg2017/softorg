    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a href=""><i class="fa fa-th"></i> <span>Super</span>
                ...
                <li class="treeview">
                    <a href=""><i class="fa fa-th"></i> <span>机构管理</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-left pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        <li><a href="{{url('/super/admin/org/list')}}"><i class="fa fa-circle-o text-red"></i><span>机构列表</span></a></li>
                        <li><a href="{{url('/super/admin/org/menu/list')}}"><i class="fa fa-circle-o text-red"></i><span>目录列表</span></a></li>
                        <li><a href="{{url('/super/admin/org/item/list')}}"><i class="fa fa-circle-o text-red"></i><span>内容列表</span></a></li>
                    </ul>
                </li>
