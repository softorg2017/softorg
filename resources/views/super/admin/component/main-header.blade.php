            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown tasks-menu add-menu">
                    ...
                    <ul class="dropdown-menu">
                        <li class="header">
                            <a href="{{url(config('common.super.admin.prefix').'/org/create')}}">
                                <i class="fa fa-plus text-red"></i> 添加机构
                            </a>
                        </li>
                        <li class="header">
                            <a href="{{url(config('common.super.admin.prefix').'/menu/create')}}">
                                <i class="fa fa-plus text-red"></i> 添加目录
                            </a>
                        </li>
                        <li class="header">
                            <a href="{{url(config('common.super.admin.prefix').'/item/create')}}">
